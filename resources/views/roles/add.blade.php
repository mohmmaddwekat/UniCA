      ...
      <div class="row">
        <div class="col-12">
          <div class="card " >
            ...
            <!-- /.card-header -->
            <form class="needs-validation" action="{{route('roles.role.save')}}" method="post" enctype="multipart/form-data">
               @if ($errors->any())
                              ...
                              <td>
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input {{$permission[0]}}" type="checkbox" id="{{$permission[0].'_'.$item->id}}" name="permissions[]" 
                                      value="{{$item->id}}" @if (old('permissions')&&in_array($item->id,old('permissions'))) checked @endif>
