            ...
            <div class="row">
                <div class="col-12">
                    <div class="card ">
                        ...
                        <!-- /.card-header -->
                        <form class="needs-validation" action="{{ route('roles.role.update', $role->id) }}" method="post"
                            enctype="multipart/form-permission">
                            @if ($errors->any())
                                ...
                                <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    ...
                                                    value="{{ $permission->id }}"
                                                    @if ($role_permissions && in_array($permission->id, $role_permissions)) checked @endif>
                                    ...
                                    @empty
                                        ...
                                        <a href="{{ route('permission.add') }}"
                                            class="btn btn-block btn-outline-primary">{{ __('Add Permission') }}</a>
                                    @endforelse
                                </ul>
                            </div>
