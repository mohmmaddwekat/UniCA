...
<div class="row">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control @error('university_name') is-invalid @enderror" name="university_name" value="{{ old('university_name', $university['university_name']) }}" id="university_name" placeholder="{{__('Enter University Name')}}" >
      </div>
      <div class="form-group">
        <label for="phone_number">{{__('Phone Number')}}</label>
        <input type="tel" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number', $university['phone_number']) }}" id="phone_number" placeholder="{{__('Enter Phone Number')}}" >
    </div>
      ...
      <div class="form-group">
        <label>{{__('City')}}</label>
        <select class="form-control  selectpicker @error('city_id') is-invalid @enderror" name="city_id"   data-selected-text-format="count" data-live-search="true">
