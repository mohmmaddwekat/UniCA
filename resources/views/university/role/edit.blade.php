        ...
        <div class="row">
          <div class="col-12">
            <div class="card " >
              ...
              <!-- /.card-header -->
              <form class="needs-validation" action="{{route('university.role.update',$role->id)}}" method="post" enctype="multipart/form-ability">
                 @if ($errors->any())
                                ...
                                <td>
                                  <div class="custom-control custom-checkbox">
                                      <input class="custom-control-input {{$ability[0]}}" type="checkbox" id="{{$ability[0].'_'.$item->id}}" name="abilities[]" 
                                        value="{{$item->id}}" @if ($role_abilities&&in_array($item->id,$role_abilities)) checked @endif>
