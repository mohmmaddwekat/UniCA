    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <form class="needs-validation" action="{{route('university.department.save')}}" method="post" enctype="multipart/form-data">
          <!-- /.card-header -->
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('head_of_department') is-invalid @enderror" name="head_of_department" value="{{ old('head_of_department') }}" id="exampleInputName1" placeholder="{{__('Enter Head of Department')}}" required>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control  selectpicker @error('college') is-invalid @enderror" name="college"   data-selected-text-format="count" data-live-search="true">
                    ...
                    @foreach ($colleges as $college)
                        <option value="{{$college->id}}"@if (old('college')&& old('college') == $college->id)
                          selected
