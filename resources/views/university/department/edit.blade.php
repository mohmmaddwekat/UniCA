                                      ...
                                      <select class="form-control  selectpicker @error('college') is-invalid @enderror"
                                          ...
                                          @foreach ($colleges as $college)
                                              <option value="{{ $college->id }}"
                                                  @if (old('college', $department->college_id) && old('college', $department->college_id) == $college->id) selected @endif>
                                                  {{ $college->name }}</option>
                                          @endforeach
                                      </select>
                                      @error('college')
                                      ...
                                      <select class="form-control  selectpicker @error('user') is-invalid @enderror"
                                          ...
                                          @foreach ($users as $user)
                                              <option value="{{ $user->id }}"
                                                  @if (old('user', $department->user_id) && old('user', $department->user_id) == $user->id) selected @endif>{{ $user->name }}
                                              </option>
                                          @endforeach
                                      </select>
                                      @error('user')
