                    ...
                    <tr>
                        <td align="center"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Uni<span style="color: #5caad2;">CA</span>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 24px">
                                            <h1>{{ $details['title'] }}</h1>
                                            <p>Hi <span>{{ $details['name'] }}</span></p>
                                            <p>{{ $details['body'] }} <a href="{{config('app.url')}}">{{ $details['btn'] }}</a></p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                    ...
                                    <td align="left"
                                        ...
                                        <div
                                            ...
                                            Email us: <br /> <a href="mailto:"
                                                style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">unica.mail0@gmail.com</a>
